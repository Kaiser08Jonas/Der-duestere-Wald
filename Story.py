...
class Story:
    ...
    def the_big_tree(self):
        ...
        match answer:
            ...
            case "Osten":
                print()
                print(f'"Ich will tiefer in den Wald gehen!" sagte {self.player_name} entschlossen und ging los.')
                self.forest()
            case _:
                print()
                print(self.colored_wrong_answer)
    ...
    def hut(self):
        ...
        print(f'"Hmmm die Hütte scheint nur einen Eingang zu haben. Eine Tür auf der Vorderseite."\n'
              f'"Vielleicht sollte ich die Hütte im {self.colored_west} betreten"\n'
              f'"Allerdings könnte ich erst einmal in Richtung {self.colored_south} um das Haus herumgehen'
              f' oder wieder\n zurück zum großen Baum im {self.colored_east} gehen."')
        answer = input('> ')
        match answer:
            case "Westen":
                print()
    ...
    def cave(self):
        ...
        if not self.behind_cave:
            print(f'"Ohhh nein" flüsterst du. "Da vorne liegt ein Bär. Anscheinend schläft er."\n'
                  ...
                  f'"Soll ich einfach wieder in Richtung {self.colored_north} aus der Höhle heraus?\n'
                  f'Aber vielleicht kann ich mich auch über einen Pfad im {self.colored_east} an ihm vorbeischleichen,'
    ...
    def deeper_in_the_forest(self):
        ...
        print()
        print(
            f'"Dort vorne ist ein Licht. Es sieht aus wie das eines Lagerfeuer welches im {self.colored_south} brennt. '
            f'Dort ist doch bestimmt irgend jemand."\n'
            f'"Allerdings könnte ich auch diesem Weg in den {self.colored_east} folgen. '
            f'Vielleicht bringt der mich an einen interessanten Ort."\n'
            f'"An beiden Orten könnte es gefährlich sein. Sollte ich wieder zurück in den {self.colored_west} gehen?')
        answer = input('> ')
        match answer:
            case "Süden":
                print()
    ...
    def get_spellbook(self):
        ...
        print(f'Am ender der Stufen geht {self.player_name} um eine Ecke.')
        if not self.spellbook:
            print(f'"Ein geheimer Raum in dessen Mitte ein Podest mir einem merkwürdigen Buch steht"\n'
                  ...
                  f'"Ich kann das im {self.colored_north} liegende Buch mitnehmen '
            ...
            match answer:
                case "Westen":
                    ...
                    print('Du greifst zwischen die Leichen hinein und versuchst das was dort glänzt zu bekommen.\n'
                          '"Das ist so ekelhaft." Schließlich erreichst du das Objekt mit deinen Fingern '
                ...
                case "Süden":
                    print()
                    print(
                        '"Was auch immer es ist, es ist es mir nicht wert dort hinein zu greifen. '
                        'Raus aus dieser Höhle"\n'
                        'als du die Höhle verlässt stehst du auf einmal im Schatten eines riesigen schwarzen Turmes.')
                    self.black_tower()
                case _:
                    print()
    ...
    def black_tower(self):
        ...
        print('"Dort vorne ist ein riesiger schwarzer Turm. Was erwartet mich dort wohl schon wieder?"\n'
              f'"Vielleicht sollte ich nicht nach {self.colored_west} zum Turm gehen. '
        ...
        match answer:
            case "Westen":
                ...
                print(
                    ...
                    f'"Vielleicht ist dort ja jemand drinnen der mich versklavt, oder noch schlimmeres mit mir tut."\n'
            ...
            case "Norden":
                ...
                print(
                    ...
                    f'"Ich kann weiter in den {self.colored_north} gehen und die Klippe hinunter springen.\n'
                    f'Jedoch komme dann nicht mehr zurück zum Turm im {self.colored_south}."')
                answer = input('> ')
                if answer == 'Norden':
                    print()
                    print(
    ...
    def campfire(self):
        ...
        coloured_tolloni = Fore.GREEN + "Tonolli" + Fore.WHITE
        coloured_jakobus = Fore.RED + 'Jakobus' + Fore.WHITE
        ...
        match answer:
            ...
            case "Süden":
                print()
                print('"Ich habe gerade leider keine Zeit dafür. '
            ...
            case "Osten":
                ...
                if not self.whisper:
                    ...
                    print(
                        'Du fühlst dich bei dem Fall so frei, '
                        'dass du für einen Augenblick alle deine Sorgen vergisst,\n'
                        '"Was passiert jetzt? Ich werde Sterben!" '
